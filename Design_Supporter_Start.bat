...
echo.
echo [1/3] 로컬 웹뷰(Next.js)를 실행합니다...
CD /D "%~dp0web-view"
start cmd /k "npm run dev"

echo.
echo [2/3] ComfyUI는 수동으로 실행해 주세요.
echo       경로: ComfyUI_windows_portable\run_nvidia_gpu.bat

echo.
echo [3/3] 데스크탑 에이전트를 실행합니다 (Local First mode)...
